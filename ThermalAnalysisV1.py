...
#=====================================================#
#Asorbitivity
#absorb1 = absorb #.14          #Play with this parameter
#Emissivity
#emitAl = emiss #0.22      #Play with this parameter 
'''
...
#LEO (Low Earth Orbit)
#h = 300 #km
def runSimulation(h, Tmin, Tmax, absorb, emitAl, Qelec, A1f, dt):
    #Orbital parameters:
    #=================================#
    #Constants 
    G = 6.67430e-11
    ...
    #A1f = 22919 #mm from solidworks area of one face
    A1f = A1f/1e6                         #Play with this parameter
    At = 4*A1f                            #Play with this parameter
    
    
    As = 2 *A1f #Area that faces sun
    Ae = A1f #Area that faces earth 
    #=====================================================#
    #Orbital parameters
    ...
    qt = q_earth_reflected+q_earth_emitted+qs
    #=========================================#
    ...
    #=======================================================================#
    '''
    plt.subplots(nrows = 2, ncols = 2, figsize =(15,10), dpi = 80)
    plt.subplot(2,2,1)
    ...
    return r_orb, P, orb_vel, t, qs, qt, Ts, Xe, Xa
#=======================================================================#
tmin = 0; tmax = 40; A1f = 22919; dt= 100; h = 300
#runSimulation(h, tmin, tmax, absorb1, emitAl, A1f, dt)
